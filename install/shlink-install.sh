...
apt-get update
apt-get install -y apache2 php8.4 php8.4-cli php8.4-fpm php8.4-json php8.4-curl php8.4-pdo php8.4-intl php8.4-gd php8.4-gmp php8.4-apcu php8.4-xml php8.4-mysql unzip curl mariadb-client
...
curl -L -o shlink-dist.zip "$LATEST_URL"
unzip shlink-dist.zip -d shlink
rm shlink-dist.zip
